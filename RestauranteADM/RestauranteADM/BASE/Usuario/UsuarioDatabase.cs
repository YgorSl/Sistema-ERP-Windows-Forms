...
namespace RestauranteADM.BASE.Usuario
{
    public class UsuarioDatabase
    {
        ...
        {
            string script = @"INSERT INTO `mydb`.`tb_permissao` (nm_login, ds_senha, id_funcionario, perm_total, perm_cadastro,perm_consulta ,perm_vendas, perm_compras, perm_rh, perm_financeiro,perm_estoque, perm_cadastrarcliente, perm_cadastrarfornecedor, perm_cadastrarproduto, perm_cadastrarcardapio, perm_cadastrarfuncionario, perm_cadastrarpedido, perm_cadastrarvenda, perm_cadastrarfolha, perm_consultarcliente, perm_consultarfornecedor, perm_consultarproduto, perm_consultarcardapio, perm_consultarfuncionario, perm_consultarpedido, perm_consultarvenda, perm_consultarfolha, perm_alterarcliente, perm_alterarfornecedor, perm_alterarfuncionario, perm_alterarproduto, perm_alterarcardapio, perm_alterarpedido, perm_alterarvenda, perm_excluircliente,perm_excluirfornecedor, perm_excluirfuncionario, perm_excluirproduto, perm_excluircardapio, perm_excluirpedido, perm_excluirvenda, perm_excluirfolha) 
                                  VALUES   (@nm_login, @ds_senha, @id_funcionario, @perm_total, @perm_cadastro,@perm_consulta , @perm_vendas, @perm_compras, @perm_rh, @perm_financeiro,@perm_estoque, @perm_cadastrarcliente, @perm_cadastrarfornecedor, @perm_cadastrarproduto, @perm_cadastrarcardapio, @perm_cadastrarfuncionario, @perm_cadastrarpedido, @perm_cadastrarvenda, @perm_cadastrarfolha, @perm_consultarcliente, @perm_consultarfornecedor, @perm_consultarproduto, @perm_consultarcardapio, @perm_consultarfuncionario, @perm_consultarpedido, @perm_consultarvenda, @perm_consultarfolha, @perm_alterarcliente, @perm_alterarfornecedor, @perm_alterarfuncionario, @perm_alterarproduto, @perm_alterarcardapio, @perm_alterarpedido, @perm_alterarvenda, @perm_excluircliente,@perm_excluirfornecedor, @perm_excluirfuncionario, @perm_excluirproduto, @perm_excluircardapio, @perm_excluirpedido, @perm_excluirvenda, @perm_excluirfolha)  ";
